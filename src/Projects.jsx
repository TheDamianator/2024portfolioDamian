...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      url: "/LDR",
      description:
        "A.I Based story telling game that goes through the hardships that make a long distance relationship work.",
      btn1: "Design",
      btn2: "A.I",
      btn3: "Storytelling",
    },
  ...
  return (
    <div
      id="projects"
      className="bg-primarywhite min-h-screen font-custom font-bold flex flex-col justify-center items-center relative"
    >
      <Fade fraction={0.1}>
