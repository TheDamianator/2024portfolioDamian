    ...
    const processSteps = [
        {
            text: (
                <>
                    ...
                    <br></br>
                    A month before this project started, i was invited to particpate in a hackathon hosted by Jumbo JTC. The goal of the hackathon was to come up with a new innovative idea that would help Jumbo JTC in their daily business, in less than 24 hours. The hackathon was a great success, awarding our grouo with the "golden ticket", which progressed us to the finals and i was asked to continue it for the duration of my minor.
                    <br></br>
                    <br></br>
