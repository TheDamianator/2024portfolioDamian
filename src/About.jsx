              ...
              <Fade fraction={0.1}>
                <div className="mb-6">
                  <p className="text-m text-lightertext mb-6">
                    Welcome! I'm Damian Caelen and I'm passionate about crafting exceptional web experiences that not
                    only look stunning but also deliver seamless functionality.
                    <br /> <br />
                    Born and raised in the Netherlands, I have a big passion for design and technology. I'm currently
                    studying Frontend Development at Fontys University of Applied Sciences in Eindhoven.
                    <br /> <br />
                    Below, you'll find a showcase of my expertise, my coding, and the design tools I use to sculpt great
                    experiences.
                  </p>
                </div>
              </Fade>
                  ...
                  <div className="flex">
                    {stackImages1.map((img, index) => (
                      <div key={index} className="relative">
                        ...
                        />
                        <span className="absolute opacity-0 bg-white text-black px-2 py-1 rounded-md z-10 text-sm transition-opacity duration-300 hover:opacity-100 top-10 left-0 transform -translate-y-full">
                          {img.alt}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="flex">
                    {toolImages.map((img, index) => (
                      <div key={index} className="relative">
                        ...
                        />
                        <span className="absolute opacity-0 bg-white text-black z-10 px-2 py-1 rounded-md text-sm transition-opacity duration-300 hover:opacity-100 top-10 left-0 transform -translate-y-full">
                          {img.alt}
                        </span>
                      </div>
                    ))}
