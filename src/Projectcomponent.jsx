  ...
  return (
    <>
      <section className="flex flex-col md:flex-row justify-center gap-5 ml-10 mr-10 md:ml-20 md:mr-20">
        ...
        <div className="flex flex-col items-center justify-center gap-2 pt-5 md:pt-20 w-full md:w-[50%]">
          {" "}
          {/* Adjusted spacing and width */}
          <img className="w-full md:max-w-[600px]" src={props.heroimg} alt="Project Hero Image" />{" "}
      ...
      <section className="process-section mr-10 flex flex-col pl-5 md:pl-20">
        {" "}
        {/* Adjusted padding */}
        {props.processSteps &&
